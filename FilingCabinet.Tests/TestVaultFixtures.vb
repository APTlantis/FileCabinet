...
Namespace FilingCabinet.Tests
    Public NotInheritable Class TestVaultFixtures
        ...
        Public Shared Function EmptyVault(workspace As TestWorkspace) As Global.FilingCabinet.CatalogData
            Dim service As New Global.FilingCabinet.CatalogService(workspace.CatalogPath, workspace.VaultRoot)
            Return service.LoadOrCreate()
        End Function

        Public Shared Function TinyNormalVault(workspace As TestWorkspace) As Global.FilingCabinet.CatalogData
            Dim service As New Global.FilingCabinet.CatalogService(workspace.CatalogPath, workspace.VaultRoot)
        ...
        Public Shared Function DuplicateFileVault(workspace As TestWorkspace) As Global.FilingCabinet.CatalogData
            Dim service As New Global.FilingCabinet.CatalogService(workspace.CatalogPath, workspace.VaultRoot)
            Dim catalog = service.LoadOrCreate()
        ...
        Public Shared Function MissingFileVault(workspace As TestWorkspace) As Global.FilingCabinet.CatalogData
            Dim service As New Global.FilingCabinet.CatalogService(workspace.CatalogPath, workspace.VaultRoot)
            Dim catalog = service.LoadOrCreate()
        ...
        Public Shared Function CompleteArtifact(id As String, name As String, storedPath As String, vaultRoot As String, originalRelativePath As String) As Global.FilingCabinet.ArtifactModel
            Dim hashes As New Global.FilingCabinet.FileHashes With {
            ...
            If File.Exists(storedPath) Then
                hashes = New Global.FilingCabinet.HashService().ComputeHashes(storedPath)
            End If
            ...
            Return New Global.FilingCabinet.ArtifactModel With {
                ...
                .Skein = hashes.Skein,
                .HashStatus = "Verified",
                .ThumbnailStatus = Global.FilingCabinet.ThumbnailService.NotApplicableStatus,
