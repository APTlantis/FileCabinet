# Filing Cabinet — Trust and Verification Model

Filing Cabinet earns trust by making vault state inspectable.
...
Filing Cabinet relies on a few plain trust anchors:
