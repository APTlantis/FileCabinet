...
Namespace FilingCabinet.Tests
    ...
    Public Class RepairLogServiceTests
        ...
        Sub AppendCreatesVaultLocalJsonLinesRepairLog()
            ...
            Try
                Dim service = New Global.FilingCabinet.RepairLogService()

                Dim logPath = service.Append(vaultRoot, New Global.FilingCabinet.RepairLogEntry With {
        ...
        Private Shared Function Entry(subject As String) As Global.FilingCabinet.RepairLogEntry
            Return New Global.FilingCabinet.RepairLogEntry With {
        ...
        Private Shared Function CreateTempVaultRoot() As String
            Dim tempRoot = Path.Combine(Path.GetTempPath(), "FilingCabinetTests", Guid.NewGuid().ToString("N"))
